...
fun RequestAppointmentScreen(
    ...
    when (val s = step) {
        ...
        is RequestStep.Reason -> RequestReasonContent(
            ...
            onFocusHandled = viewModel::consumeReasonFocus,
                ...
                Column(
                    ...
                    Box(
                        modifier = Modifier
                            .size(80.dp)
                            .background(
                                EyecareColors.current.statusConfirmed.copy(alpha = 0.14f),
                                CircleShape,
                            ),
                    ...
                    Column(
                        ...
                        Text(
                            text = "Your request is now with the clinic.",
                    ...
                    Surface(
                        ...
                        Column(
                            ...
                            Text(
                                text = state.request.requestNumber,
                    ...
                    Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
                        NonBindingNotice()
                        Text(
                            text = "We'll notify you when the clinic responds.",
                            style = MaterialTheme.typography.bodyMedium,
                            color = MaterialTheme.colorScheme.onSurfaceVariant,
                            textAlign = TextAlign.Center,
                            modifier = Modifier.fillMaxWidth(),
