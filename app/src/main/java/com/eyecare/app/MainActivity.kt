...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Start with light system bars while the persisted appearance preference is read.
        enableEdgeToEdge(
        ...
        window.setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_ADJUST_RESIZE)
            setContent {
            val themePreference by themePreferences.themePreference.collectAsStateWithLifecycle()
            val darkTheme = themePreference.isDark(isSystemInDarkTheme())
            ...
            EyecareTheme(darkTheme = darkTheme) {
